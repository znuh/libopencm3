 ...
 *
 * @brief <b>Defined Constants and Types for the STM32C0xx System Configuration controller </b>
 *
 * @version 1.0.0
 *
 * @author @htmlonly &copy; @endhtmlonly 2019
 * Guillaume Revaillot <g.revaillot@gmail.com>, 2025 Benedikt Heinz <zn000h@gmail.com>
 *
...
#define SYSCFG_CFGR3			MMIO32(SYSCFG_BASE + 0x3C)
...
#define SYSCFG_CFGR1_I2C_PC14_FMP		(1 << 24)
...
/** @defgroup syscfg_cfgr3 CFGR3 SYSCFG configuration register 3
@{*/
...
@{*/
#define SYSCFG_ITLINE1_PVM_VDDIO2_OUT		(1 << 0)
/**@}*/
...
@{*/
#define SYSCFG_ITLINE30_FDCAN_IT0	(1 << 0)
/**@}*/

/** @defgroup syscfg_itline31 ITLINE31 interrupt line 31 status register
@{*/
#define SYSCFG_ITLINE30_FDCAN_IT1	(1 << 0)
/**@}*/
