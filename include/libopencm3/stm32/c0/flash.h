 ...
 *
 * @brief <b>Defined Constants and Types for the STM32C0xx Flash Control</b>
 *
 * @version 1.0.0
 *
...
/** SECURE_MUXING_EN: Multiple-bonding security **/
#define FLASH_OPTR_SECURE_MUXING_EN		(1 << 23)
/** FLASH_OPTR_RAM_PARITY_CHECK SRAM parity check control **/
#define FLASH_OPTR_RAM_PARITY_CHECK		(1 << 22)
/** HSE_NOT_REMAPPED: HSE remapping enable/disable **/
#define FLASH_OPTR_HSE_NOT_REMAPPED		(1 << 21)
...
#define FLASH_OPTR_BORF_LEV_SHIFT	11
...
#define FLASH_OPTR_BORR_LEV_SHIFT	9
